...
transform holo_panel:
    # 用于全息面板的通用变换

screen holo_corners():
    # 四角L形角标装饰
    add Solid("#00C8FF") pos (0, 0) size (24, 2)
    add Solid("#00C8FF") pos (0, 0) size (2, 24)

    add Solid("#00C8FF") pos (1.0, 0.0) xanchor 1.0 size (24, 2)
    add Solid("#00C8FF") pos (1.0, 0.0) xanchor 1.0 size (2, 24)

    add Solid("#00C8FF") pos (0.0, 1.0) yanchor 1.0 size (24, 2)
    add Solid("#00C8FF") pos (0.0, 1.0) yanchor 1.0 size (2, 24)

    add Solid("#00C8FF") pos (1.0, 1.0) xanchor 1.0 yanchor 1.0 size (24, 2)
    add Solid("#00C8FF") pos (1.0, 1.0) xanchor 1.0 yanchor 1.0 size (2, 24)
        ...
        vbox:
            ...
            hbox:
                ...
                frame:
                    ...
                    vbox:
                        ...
                        textbutton "点击继续 [X]":
                            action Preference("click continue", "toggle")
                            text_size 20
                            text_color "#E8F0FF"
                            text_hover_color "#4DD9FF"
                            xalign 0.5
            ...
            frame:
                ...
                hbox:
                    ...
                    textbutton "字体放大":
                        action Preference("font size", "increase")
                        text_size 18
                        text_color "#E8F0FF"
                        text_hover_color "#4DD9FF"

                    textbutton "减少动效":
                        action Preference("reduce motion", "toggle")
                        text_size 18
                        text_color "#E8F0FF"
                        text_hover_color "#4DD9FF"
